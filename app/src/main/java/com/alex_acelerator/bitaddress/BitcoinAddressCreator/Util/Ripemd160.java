...
public final class Ripemd160 {
    ...
    public static void main(String[] args) {
        String msg = "ac8a9fa3c12b209ee321e5e39f37a803da619b55ff4ca5b44bd3214b8ac167c7";
        System.out.println(getHash(hexToBytes(msg)));
        System.out.println("bc871f36ecc625ee667e5df65d7be0ac49f7ac1d");
    }
    ...
    public static String getHash(byte[] msg) {
        ...
        //  Convert to string in little endian
        StringBuilder result = new StringBuilder();
        byte temp;
        for (int i = 0; i < state.length * 4; i++) {
            temp = (byte) (state[i / 4] >>> (i % 4 * 8));
